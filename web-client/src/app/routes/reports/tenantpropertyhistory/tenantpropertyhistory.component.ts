import {
  ...
  @Component({
    selector: "app-tenantpropertyhistory",
    templateUrl: "./tenantpropertyhistory.component.html",
    styleUrls: ["./tenantpropertyhistory.component.scss"],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe]
  })
  export class TenantPropertyHistoryComponent implements OnInit {
    ...
    getData(pageInfo: any, query?: string) {
      ...
      this.assignedPropertyService
        ...
        .subscribe(result => {
          ...
          this.rows=this.rows.filter(x=>x.tenantId==this.tenantId);
