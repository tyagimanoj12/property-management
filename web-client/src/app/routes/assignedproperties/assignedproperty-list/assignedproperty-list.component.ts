...
@Component({
  selector: "app-assignedproperty-list",
  templateUrl: "./assignedproperty-list.component.html",
  styleUrls: ["./assignedproperty-list.component.scss"],
  encapsulation: ViewEncapsulation.None,
  providers: [DatePipe]
})
export class AssignedPropertyListComponent implements OnInit {
  ...
  onRowClick(event) {
    ...
    if (this.assignedPropertyId) {
      ...
      this.assignedPropertyService
        .getAssignedProperty(this.assignedPropertyId)
        .subscribe(data => {
          
          this.assignPropertyForm.setValue(data);
